...
contract Mackandal is TRC20Interface, Owned {
    ...
    // Token owner can approve for `spender` to transfer from the token owner's account
    ...
    // Token owner can approve for `spender` to transfer from the token owners account
